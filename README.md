...
| **`assignLabelToUnit`** *(write, opt-in)* | Change a translation unit by assigning an existing project label and saving an explanation; enable explicitly in `prompt.config` |
